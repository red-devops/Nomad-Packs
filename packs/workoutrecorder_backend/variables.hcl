...
variable "docker_image" {
  ...
  type        = string
  default     = "ghcr.io/red-devops/workoutrecorder-backend"
}
...
variable "service_name" {
  description = "The service name for the workoutrecorder_backend application"
  type        = string
  default     = "workoutrecorder-backend"
}
